...
## Автор
**Казьмин Даниил** (пример - замените на своё имя)

## Описание программы
Book Tracker - это приложение для управления списком прочитанных книг. Программа позволяет:
...
```bash
git clone https://github.com/python-Book-Tracker/book_tracker.git
cd book_tracker
